...
export interface DesignProgress {
  ...
  /**
   * True when the hands-free auto pipeline produced this design, false when the
   * researcher drove it stage by stage. Surfaced in the lists so the two kinds
   * are distinguishable at a glance - they warrant different scrutiny.
   */
...
export function getDesignProgress(raw: {
  ...
  return {
    ...
    isAutoGenerated: parsed?.autoGenerated === true
  }
}
