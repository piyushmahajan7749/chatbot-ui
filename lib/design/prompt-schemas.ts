...
const literatureWorkflow = [
  ...
  "4. Prioritize literature that investigates similar systems/conditions/mechanisms, reports experimental methods and quantitative outcomes, addresses the same/related variables, and provides insight into successes/failures/trade-offs.",
